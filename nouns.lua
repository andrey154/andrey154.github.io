-- package.path = "./lualib/?.lua;./lualib/ustring/?.lua;" .. package.path
package.path = "./lualib/?.lua;" .. package.path

local mw =  require("lualib.mwInit")
mw.ustring = require("lualib.ustring.ustring")
...
| style="min-width: 12em;" | <span class="form-of plural-nominative-form-of lang-fi">{{{nom_pl:c}}}</span>
|- class="vsShow" style="background: #F2F2FF; vertical-align: top;"
...
| {{{nom_sg}}}
| <span class="form-of plural-nominative-form-of lang-fi">{{{nom_pl}}}</span>
|- class="vsHide" style="background: #F2F2FF; vertical-align: top;"
! style="background: #CCCCFF;" rowspan="2" | accusative
! style="background: #CCCCFF;" | nom.<sup style="border-bottom: 1px dotted black; cursor: help;" title="The nominative accusative is used, for example, as the object of certain passives and imperatives."></sup>
| {{{nom_sg}}}
| rowspan="2" | <span class="form-of plural-nominative-form-of lang-fi">{{{nom_pl}}}</span>
|- class="vsHide" style="background: #F2F2FF; vertical-align: top;"
